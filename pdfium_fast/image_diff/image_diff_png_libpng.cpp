...
bool DoLibpngWrite(png_struct* png_ptr,
  ...
  // Disable PNG filtering to avoid filter selection overhead (33.5% of encoding time).
  // With PNG_FILTER_NONE, each scanline is prefixed with filter byte 0 (no filter).
  // This trades ~10-30% larger file size for 30-40% faster encoding.
