...
PDF_NAME = "arxiv_035.pdf"
PDF_STEM = "arxiv_035"
PDF_REL_PATH = "arxiv_035.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "arxiv" / "arxiv_035"
...
@pytest.mark.arxiv
def test_text_extraction_arxiv_035(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for arxiv_035.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.arxiv
def test_jsonl_extraction_arxiv_035(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for arxiv_035.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
