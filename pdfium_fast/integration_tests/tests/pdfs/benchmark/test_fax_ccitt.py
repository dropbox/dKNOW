...
Markers: full,batch_bulk,benchmark
...
PDF_NAME = "fax_ccitt.pdf"
PDF_STEM = "fax_ccitt"
PDF_REL_PATH = "fax_ccitt.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "benchmark" / "fax_ccitt"
...
def test_text_extraction_fax_ccitt(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for fax_ccitt.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.benchmark
def test_jsonl_extraction_fax_ccitt(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for fax_ccitt.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
