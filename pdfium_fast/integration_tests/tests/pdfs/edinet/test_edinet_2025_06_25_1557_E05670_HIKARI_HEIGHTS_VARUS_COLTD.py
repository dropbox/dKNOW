"""
Tests for edinet_2025-06-25_1557_E05670_HIKARI HEIGHTS-VARUS COLTD.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: edinet_2025-06-25_1557_E05670_HIKARI HEIGHTS-VARUS COLTD.pdf
Category: benchmark
...
PDF_NAME = "edinet_2025-06-25_1557_E05670_HIKARI HEIGHTS-VARUS COLTD.pdf"
PDF_STEM = "edinet_2025-06-25_1557_E05670_HIKARI HEIGHTS-VARUS COLTD"
PDF_REL_PATH = "edinet_2025-06-25_1557_E05670_HIKARI HEIGHTS-VARUS COLTD.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edinet" / "edinet_2025-06-25_1557_E05670_HIKARI HEIGHTS-VARUS COLTD"
...
@pytest.mark.edinet
def test_text_extraction_edinet_2025_06_25_1557_E05670_HIKARI_HEIGHTS_VARUS_COLTD(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for edinet_2025-06-25_1557_E05670_HIKARI HEIGHTS-VARUS COLTD.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edinet
def test_jsonl_extraction_edinet_2025_06_25_1557_E05670_HIKARI_HEIGHTS_VARUS_COLTD(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for edinet_2025-06-25_1557_E05670_HIKARI HEIGHTS-VARUS COLTD.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
