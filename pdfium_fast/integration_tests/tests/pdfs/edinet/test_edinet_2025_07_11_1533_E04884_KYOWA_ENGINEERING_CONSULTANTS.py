"""
Tests for edinet_2025-07-11_1533_E04884_KYOWA ENGINEERING CONSULTANTS.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: edinet_2025-07-11_1533_E04884_KYOWA ENGINEERING CONSULTANTS.pdf
Category: benchmark
Size: unknown (unknown pages)
Markers: full,standard_60_set,batch_bulk,edinet
...
PDF_NAME = "edinet_2025-07-11_1533_E04884_KYOWA ENGINEERING CONSULTANTS.pdf"
PDF_STEM = "edinet_2025-07-11_1533_E04884_KYOWA ENGINEERING CONSULTANTS"
PDF_REL_PATH = "edinet_2025-07-11_1533_E04884_KYOWA ENGINEERING CONSULTANTS.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edinet" / "edinet_2025-07-11_1533_E04884_KYOWA ENGINEERING CONSULTANTS"
...
@pytest.mark.full
@pytest.mark.standard_60_set
@pytest.mark.batch_bulk
@pytest.mark.edinet
def test_text_extraction_edinet_2025_07_11_1533_E04884_KYOWA_ENGINEERING_CONSULTANTS(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for edinet_2025-07-11_1533_E04884_KYOWA ENGINEERING CONSULTANTS.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edinet
def test_jsonl_extraction_edinet_2025_07_11_1533_E04884_KYOWA_ENGINEERING_CONSULTANTS(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for edinet_2025-07-11_1533_E04884_KYOWA ENGINEERING CONSULTANTS.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
