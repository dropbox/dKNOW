"""
Tests for edinet_2025-06-25_1027_E01750_DAIHEN CORPORATION.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: edinet_2025-06-25_1027_E01750_DAIHEN CORPORATION.pdf
Category: benchmark
...
PDF_NAME = "edinet_2025-06-25_1027_E01750_DAIHEN CORPORATION.pdf"
PDF_STEM = "edinet_2025-06-25_1027_E01750_DAIHEN CORPORATION"
PDF_REL_PATH = "edinet_2025-06-25_1027_E01750_DAIHEN CORPORATION.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edinet" / "edinet_2025-06-25_1027_E01750_DAIHEN CORPORATION"
...
@pytest.mark.edinet
def test_text_extraction_edinet_2025_06_25_1027_E01750_DAIHEN_CORPORATION(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for edinet_2025-06-25_1027_E01750_DAIHEN CORPORATION.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edinet
def test_jsonl_extraction_edinet_2025_06_25_1027_E01750_DAIHEN_CORPORATION(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for edinet_2025-06-25_1027_E01750_DAIHEN CORPORATION.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
