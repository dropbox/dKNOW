...
PDF_NAME = "japanese_004.pdf"
PDF_STEM = "japanese_004"
PDF_REL_PATH = "japanese_004.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "japanese" / "japanese_004"
...
def test_text_extraction_japanese_004(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for japanese_004.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.japanese
def test_jsonl_extraction_japanese_004(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for japanese_004.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
