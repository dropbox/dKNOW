...
PDF_NAME = "japanese_015.pdf"
PDF_STEM = "japanese_015"
PDF_REL_PATH = "japanese_015.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "japanese" / "japanese_015"
...
def test_text_extraction_japanese_015(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for japanese_015.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.japanese
def test_jsonl_extraction_japanese_015(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for japanese_015.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
