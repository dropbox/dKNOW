...
PDF_NAME = "web_027.pdf"
PDF_STEM = "web_027"
PDF_REL_PATH = "web_027.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "web" / "web_027"
...
@pytest.mark.web
def test_text_extraction_web_027(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for web_027.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.web
def test_jsonl_extraction_web_027(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for web_027.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
