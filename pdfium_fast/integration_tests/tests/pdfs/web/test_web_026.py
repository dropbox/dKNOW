...
PDF_NAME = "web_026.pdf"
PDF_STEM = "web_026"
PDF_REL_PATH = "web_026.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "web" / "web_026"
...
@pytest.mark.web
def test_text_extraction_web_026(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for web_026.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.web
def test_jsonl_extraction_web_026(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for web_026.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
