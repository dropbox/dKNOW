...
PDF_NAME = "cc_002_522p.pdf"
PDF_STEM = "cc_002_522p"
PDF_REL_PATH = "cc_002_522p.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "cc" / "cc_002_522p"
...
def test_text_extraction_cc_002_522p(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for cc_002_522p.pdf"""
...
@pytest.mark.cc
@pytest.mark.large_pdf
def test_jsonl_extraction_cc_002_522p(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for cc_002_522p.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
