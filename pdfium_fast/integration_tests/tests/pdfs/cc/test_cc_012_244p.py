...
PDF: cc_012_244p.pdf
Category: benchmark
Size: large (244 pages)
Markers: full,batch_bulk,cc,large_pdf
...
PDF_NAME = "cc_012_244p.pdf"
PDF_STEM = "cc_012_244p"
PDF_REL_PATH = "cc_012_244p.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "cc" / "cc_012_244p"
...
def test_text_extraction_cc_012_244p(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for cc_012_244p.pdf"""
...
@pytest.mark.cc
@pytest.mark.large_pdf
def test_jsonl_extraction_cc_012_244p(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for cc_012_244p.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
