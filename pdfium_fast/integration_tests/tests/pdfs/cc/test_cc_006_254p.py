...
PDF_NAME = "cc_006_254p.pdf"
PDF_STEM = "cc_006_254p"
PDF_REL_PATH = "cc_006_254p.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "cc" / "cc_006_254p"
...
def test_text_extraction_cc_006_254p(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for cc_006_254p.pdf"""
...
@pytest.mark.cc
@pytest.mark.large_pdf
def test_jsonl_extraction_cc_006_254p(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for cc_006_254p.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
