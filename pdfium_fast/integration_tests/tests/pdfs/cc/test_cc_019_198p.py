...
PDF: cc_019_198p.pdf
Category: benchmark
Size: medium (198 pages)
Markers: full,standard_60_set,batch_bulk,cc,medium_pdf
...
PDF_NAME = "cc_019_198p.pdf"
PDF_STEM = "cc_019_198p"
PDF_REL_PATH = "cc_019_198p.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "cc" / "cc_019_198p"
...
def test_text_extraction_cc_019_198p(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for cc_019_198p.pdf"""
...
@pytest.mark.cc
@pytest.mark.medium_pdf
def test_jsonl_extraction_cc_019_198p(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for cc_019_198p.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
