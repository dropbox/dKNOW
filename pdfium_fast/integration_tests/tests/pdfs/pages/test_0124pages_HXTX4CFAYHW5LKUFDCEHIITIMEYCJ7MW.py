"""
Tests for 0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW.pdf
Category: benchmark
Size: medium (124 pages)
...
PDF_NAME = "0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW.pdf"
PDF_STEM = "0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW"
PDF_REL_PATH = "0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW"
...
def test_text_extraction_0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0124pages_HXTX4CFAYHW5LKUFDCEHIITIMEYCJ7MW.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
