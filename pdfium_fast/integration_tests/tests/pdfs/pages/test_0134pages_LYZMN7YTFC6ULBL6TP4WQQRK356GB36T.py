"""
Tests for 0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T.pdf
Category: benchmark
Size: medium (134 pages)
Markers: full,standard_60_set,batch_bulk,pages,medium_pdf
...
PDF_NAME = "0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T.pdf"
PDF_STEM = "0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T"
PDF_REL_PATH = "0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T"
...
def test_text_extraction_0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0134pages_LYZMN7YTFC6ULBL6TP4WQQRK356GB36T.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
