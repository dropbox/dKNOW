"""
Tests for 0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI.pdf
Category: benchmark
Size: medium (100 pages)
Markers: full,standard_60_set,smoke_fast,batch_bulk,pages,medium_pdf
...
PDF_NAME = "0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI.pdf"
PDF_STEM = "0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI"
PDF_REL_PATH = "0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI"
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_text_extraction_0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0100pages_7FKQLKX273JBHXAAW5XDRT27JGMIZMCI.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
