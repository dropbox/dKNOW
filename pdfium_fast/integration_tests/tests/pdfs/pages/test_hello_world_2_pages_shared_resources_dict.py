"""
Tests for hello_world_2_pages_shared_resources_dict.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: hello_world_2_pages_shared_resources_dict.pdf
Category: edge_cases
Size: unknown (unknown pages)
Markers: full,batch_bulk,pages
...
PDF_NAME = "hello_world_2_pages_shared_resources_dict.pdf"
PDF_STEM = "hello_world_2_pages_shared_resources_dict"
PDF_REL_PATH = "hello_world_2_pages_shared_resources_dict.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "hello_world_2_pages_shared_resources_dict"
...
@pytest.mark.pages
def test_text_extraction_hello_world_2_pages_shared_resources_dict(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for hello_world_2_pages_shared_resources_dict.pdf"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
...
@pytest.mark.batch_bulk
@pytest.mark.pages
def test_jsonl_extraction_hello_world_2_pages_shared_resources_dict(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for hello_world_2_pages_shared_resources_dict.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
