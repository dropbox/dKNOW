"""
Tests for 0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C.pdf
Category: benchmark
Size: medium (193 pages)
...
PDF_NAME = "0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C.pdf"
PDF_STEM = "0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C"
PDF_REL_PATH = "0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C"
...
def test_text_extraction_0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0193pages_CADINJMTO23ZTKPBNZ6TUOQT4BFPZC2C.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
