"""
Tests for 0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF.pdf
Category: benchmark
Size: large (277 pages)
Markers: full,standard_60_set,batch_bulk,pages,large_pdf
...
PDF_NAME = "0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF.pdf"
PDF_STEM = "0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF"
PDF_REL_PATH = "0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF"
...
def test_text_extraction_0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF.pdf"""
...
@pytest.mark.pages
@pytest.mark.large_pdf
def test_jsonl_extraction_0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0277pages_YCOBKTA46F7XEOWT4LS3BCPGDOMQSBWF.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
