"""
Tests for 0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2.pdf
Category: benchmark
Size: large (214 pages)
...
PDF_NAME = "0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2.pdf"
PDF_STEM = "0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2"
PDF_REL_PATH = "0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2"
...
def test_text_extraction_0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2.pdf"""
...
@pytest.mark.pages
@pytest.mark.large_pdf
def test_jsonl_extraction_0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0214pages_BZK65P6W74FNMD4O3A24LH3F2XLFH7V2.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
