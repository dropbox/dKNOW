"""
Tests for 0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H.pdf
Category: benchmark
Size: medium (172 pages)
...
PDF_NAME = "0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H.pdf"
PDF_STEM = "0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H"
PDF_REL_PATH = "0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H"
...
def test_text_extraction_0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0172pages_DNJIAKOPLDZDQCXT2PDA6V6DGL2MQL2H.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
