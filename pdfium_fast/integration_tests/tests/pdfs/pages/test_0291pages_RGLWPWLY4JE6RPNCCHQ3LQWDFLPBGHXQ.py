"""
Tests for 0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ.pdf
Category: benchmark
Size: large (291 pages)
...
PDF_NAME = "0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ.pdf"
PDF_STEM = "0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ"
PDF_REL_PATH = "0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ"
...
def test_text_extraction_0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ.pdf"""
...
@pytest.mark.pages
@pytest.mark.large_pdf
def test_jsonl_extraction_0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0291pages_RGLWPWLY4JE6RPNCCHQ3LQWDFLPBGHXQ.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
