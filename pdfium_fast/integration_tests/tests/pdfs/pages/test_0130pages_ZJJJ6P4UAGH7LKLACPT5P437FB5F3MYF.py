"""
Tests for 0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF.pdf
Category: benchmark
Size: medium (130 pages)
...
PDF_NAME = "0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF.pdf"
PDF_STEM = "0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF"
PDF_REL_PATH = "0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF"
...
def test_text_extraction_0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0130pages_ZJJJ6P4UAGH7LKLACPT5P437FB5F3MYF.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
