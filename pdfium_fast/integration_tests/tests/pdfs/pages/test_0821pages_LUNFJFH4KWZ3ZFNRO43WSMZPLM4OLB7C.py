"""
Tests for 0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C.pdf
Category: benchmark
Size: large (821 pages)
...
PDF_NAME = "0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C.pdf"
PDF_STEM = "0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C"
PDF_REL_PATH = "0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C"
...
def test_text_extraction_0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C.pdf"""
...
@pytest.mark.pages
@pytest.mark.large_pdf
def test_jsonl_extraction_0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0821pages_LUNFJFH4KWZ3ZFNRO43WSMZPLM4OLB7C.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
