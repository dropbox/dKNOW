"""
Tests for 0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA.pdf
Category: benchmark
Size: medium (150 pages)
...
PDF_NAME = "0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA.pdf"
PDF_STEM = "0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA"
PDF_REL_PATH = "0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA"
...
def test_text_extraction_0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0150pages_44LQBJ56XNS2C6VVWKOP2YUNKCODKTEA.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
