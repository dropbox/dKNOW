"""
Tests for 0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB.pdf
Category: benchmark
Size: large (569 pages)
...
PDF_NAME = "0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB.pdf"
PDF_STEM = "0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB"
PDF_REL_PATH = "0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB"
...
def test_text_extraction_0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB.pdf"""
...
@pytest.mark.pages
@pytest.mark.large_pdf
def test_jsonl_extraction_0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0569pages_QXQ2QSHOPBTSXLDGKKM4TYMR4R7QODHB.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
