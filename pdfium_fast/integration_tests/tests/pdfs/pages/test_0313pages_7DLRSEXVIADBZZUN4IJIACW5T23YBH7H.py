"""
Tests for 0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H.pdf
Category: benchmark
Size: large (313 pages)
...
PDF_NAME = "0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H.pdf"
PDF_STEM = "0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H"
PDF_REL_PATH = "0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H"
...
def test_text_extraction_0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H.pdf"""
...
@pytest.mark.pages
@pytest.mark.large_pdf
def test_jsonl_extraction_0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0313pages_7DLRSEXVIADBZZUN4IJIACW5T23YBH7H.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
