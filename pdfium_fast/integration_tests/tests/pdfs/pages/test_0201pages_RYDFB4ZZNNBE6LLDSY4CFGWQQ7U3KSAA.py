"""
Tests for 0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA.pdf
Category: benchmark
Size: large (201 pages)
...
PDF_NAME = "0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA.pdf"
PDF_STEM = "0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA"
PDF_REL_PATH = "0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA"
...
def test_text_extraction_0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA.pdf"""
...
@pytest.mark.pages
@pytest.mark.large_pdf
def test_jsonl_extraction_0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0201pages_RYDFB4ZZNNBE6LLDSY4CFGWQQ7U3KSAA.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
