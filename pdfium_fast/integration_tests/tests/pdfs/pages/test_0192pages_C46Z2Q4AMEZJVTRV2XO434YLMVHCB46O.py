"""
Tests for 0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O.pdf
Category: benchmark
Size: medium (192 pages)
...
PDF_NAME = "0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O.pdf"
PDF_STEM = "0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O"
PDF_REL_PATH = "0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O"
...
def test_text_extraction_0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0192pages_C46Z2Q4AMEZJVTRV2XO434YLMVHCB46O.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
