"""
Tests for 0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA.pdf
Category: benchmark
Size: large (309 pages)
...
PDF_NAME = "0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA.pdf"
PDF_STEM = "0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA"
PDF_REL_PATH = "0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA"
...
def test_text_extraction_0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA.pdf"""
...
@pytest.mark.pages
@pytest.mark.large_pdf
def test_jsonl_extraction_0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0309pages_7LD3RVJDZGTXF53CDLCI67YPWZQ5POOA.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
