"""
Tests for 0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S.pdf
Category: benchmark
Size: medium (169 pages)
...
PDF_NAME = "0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S.pdf"
PDF_STEM = "0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S"
PDF_REL_PATH = "0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S"
...
def test_text_extraction_0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0169pages_CLEQSRWNHVWUAHLTNGPYHMYOWEC4JR6S.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
