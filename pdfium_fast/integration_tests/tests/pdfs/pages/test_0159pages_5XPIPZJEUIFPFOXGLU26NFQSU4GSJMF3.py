"""
Tests for 0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3.pdf

Generated by: lib/generate_test_files.py
DO NOT EDIT - Regenerate with: python lib/generate_test_files.py

PDF: 0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3.pdf
Category: benchmark
Size: medium (159 pages)
...
PDF_NAME = "0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3.pdf"
PDF_STEM = "0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3"
PDF_REL_PATH = "0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "pages" / "0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3"
...
def test_text_extraction_0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3(benchmark_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3.pdf"""
...
@pytest.mark.pages
@pytest.mark.medium_pdf
def test_jsonl_extraction_0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3(benchmark_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 0159pages_5XPIPZJEUIFPFOXGLU26NFQSU4GSJMF3.pdf (page 0 only)"""
    pdf_path = benchmark_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
