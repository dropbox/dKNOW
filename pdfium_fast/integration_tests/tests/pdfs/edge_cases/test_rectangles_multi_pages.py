...
PDF_NAME = "rectangles_multi_pages.pdf"
PDF_STEM = "rectangles_multi_pages"
PDF_REL_PATH = "rectangles_multi_pages.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "rectangles_multi_pages"
...
def test_text_extraction_rectangles_multi_pages(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for rectangles_multi_pages.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_rectangles_multi_pages(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for rectangles_multi_pages.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
