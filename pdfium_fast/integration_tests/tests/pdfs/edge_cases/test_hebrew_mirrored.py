...
PDF_NAME = "hebrew_mirrored.pdf"
PDF_STEM = "hebrew_mirrored"
PDF_REL_PATH = "hebrew_mirrored.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "hebrew_mirrored"
...
def test_text_extraction_hebrew_mirrored(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for hebrew_mirrored.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_hebrew_mirrored(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for hebrew_mirrored.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
