...
PDF_NAME = "344775293.pdf"
PDF_STEM = "344775293"
PDF_REL_PATH = "344775293.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "344775293"
...
def test_text_extraction_344775293(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for 344775293.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_344775293(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for 344775293.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
