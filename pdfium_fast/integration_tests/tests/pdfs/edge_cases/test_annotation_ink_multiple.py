...
PDF_NAME = "annotation_ink_multiple.pdf"
PDF_STEM = "annotation_ink_multiple"
PDF_REL_PATH = "annotation_ink_multiple.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "annotation_ink_multiple"
...
def test_text_extraction_annotation_ink_multiple(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for annotation_ink_multiple.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_annotation_ink_multiple(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for annotation_ink_multiple.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
