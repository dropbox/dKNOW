...
PDF_NAME = "bad_page_type.pdf"
PDF_STEM = "bad_page_type"
PDF_REL_PATH = "bad_page_type.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "bad_page_type"
...
def test_text_extraction_bad_page_type(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for bad_page_type.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_bad_page_type(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for bad_page_type.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
