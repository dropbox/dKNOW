...
PDF_NAME = "zero_length_stream.pdf"
PDF_STEM = "zero_length_stream"
PDF_REL_PATH = "zero_length_stream.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "zero_length_stream"
...
def test_text_extraction_zero_length_stream(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for zero_length_stream.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_zero_length_stream(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for zero_length_stream.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
