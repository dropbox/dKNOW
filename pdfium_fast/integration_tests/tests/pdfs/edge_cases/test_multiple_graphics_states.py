...
PDF_NAME = "multiple_graphics_states.pdf"
PDF_STEM = "multiple_graphics_states"
PDF_REL_PATH = "multiple_graphics_states.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "multiple_graphics_states"
...
def test_text_extraction_multiple_graphics_states(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for multiple_graphics_states.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_multiple_graphics_states(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for multiple_graphics_states.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
