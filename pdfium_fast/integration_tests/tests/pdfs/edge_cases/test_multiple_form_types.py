...
PDF_NAME = "multiple_form_types.pdf"
PDF_STEM = "multiple_form_types"
PDF_REL_PATH = "multiple_form_types.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "multiple_form_types"
...
def test_text_extraction_multiple_form_types(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for multiple_form_types.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_multiple_form_types(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for multiple_form_types.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
