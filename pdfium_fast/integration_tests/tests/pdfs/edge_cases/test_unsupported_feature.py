...
PDF_NAME = "unsupported_feature.pdf"
PDF_STEM = "unsupported_feature"
PDF_REL_PATH = "unsupported_feature.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "unsupported_feature"
...
def test_text_extraction_unsupported_feature(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for unsupported_feature.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_unsupported_feature(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for unsupported_feature.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
