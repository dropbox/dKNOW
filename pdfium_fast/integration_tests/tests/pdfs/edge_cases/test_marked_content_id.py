...
PDF_NAME = "marked_content_id.pdf"
PDF_STEM = "marked_content_id"
PDF_REL_PATH = "marked_content_id.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "marked_content_id"
...
def test_text_extraction_marked_content_id(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for marked_content_id.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_marked_content_id(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for marked_content_id.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
