...
PDF_NAME = "rectangles_multi_page_xfa.pdf"
PDF_STEM = "rectangles_multi_page_xfa"
PDF_REL_PATH = "rectangles_multi_page_xfa.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "rectangles_multi_page_xfa"
...
def test_text_extraction_rectangles_multi_page_xfa(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for rectangles_multi_page_xfa.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_rectangles_multi_page_xfa(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for rectangles_multi_page_xfa.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
