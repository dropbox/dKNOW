...
PDF_NAME = "circular_viewer_ref.pdf"
PDF_STEM = "circular_viewer_ref"
PDF_REL_PATH = "circular_viewer_ref.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "circular_viewer_ref"
...
def test_text_extraction_circular_viewer_ref(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for circular_viewer_ref.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_circular_viewer_ref(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for circular_viewer_ref.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
