...
PDF_NAME = "trailer_end_trailing_space.pdf"
PDF_STEM = "trailer_end_trailing_space"
PDF_REL_PATH = "trailer_end_trailing_space.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "trailer_end_trailing_space"
...
def test_text_extraction_trailer_end_trailing_space(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for trailer_end_trailing_space.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_trailer_end_trailing_space(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for trailer_end_trailing_space.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
