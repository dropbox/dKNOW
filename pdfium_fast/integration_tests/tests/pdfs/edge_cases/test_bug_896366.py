...
PDF_NAME = "bug_896366.pdf"
PDF_STEM = "bug_896366"
PDF_REL_PATH = "bug_896366.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "bug_896366"
...
def test_text_extraction_bug_896366(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for bug_896366.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_bug_896366(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for bug_896366.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
