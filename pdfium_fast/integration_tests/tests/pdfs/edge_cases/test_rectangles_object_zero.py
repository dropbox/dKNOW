...
PDF_NAME = "rectangles_object_zero.pdf"
PDF_STEM = "rectangles_object_zero"
PDF_REL_PATH = "rectangles_object_zero.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "rectangles_object_zero"
...
def test_text_extraction_rectangles_object_zero(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for rectangles_object_zero.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_rectangles_object_zero(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for rectangles_object_zero.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
