...
PDF_NAME = "linearized_bug_1055.pdf"
PDF_STEM = "linearized_bug_1055"
PDF_REL_PATH = "linearized_bug_1055.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "linearized_bug_1055"
...
def test_text_extraction_linearized_bug_1055(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for linearized_bug_1055.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_linearized_bug_1055(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for linearized_bug_1055.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
