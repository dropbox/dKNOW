...
PDF_NAME = "freetext_annotation_without_da.pdf"
PDF_STEM = "freetext_annotation_without_da"
PDF_REL_PATH = "freetext_annotation_without_da.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "freetext_annotation_without_da"
...
def test_text_extraction_freetext_annotation_without_da(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for freetext_annotation_without_da.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_freetext_annotation_without_da(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for freetext_annotation_without_da.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
