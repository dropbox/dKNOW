...
PDF_NAME = "tagged_marked_content.pdf"
PDF_STEM = "tagged_marked_content"
PDF_REL_PATH = "tagged_marked_content.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "tagged_marked_content"
...
def test_text_extraction_tagged_marked_content(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for tagged_marked_content.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_tagged_marked_content(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for tagged_marked_content.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
