...
PDF_NAME = "uri_action_nonascii.pdf"
PDF_STEM = "uri_action_nonascii"
PDF_REL_PATH = "uri_action_nonascii.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "uri_action_nonascii"
...
def test_text_extraction_uri_action_nonascii(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for uri_action_nonascii.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_uri_action_nonascii(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for uri_action_nonascii.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
