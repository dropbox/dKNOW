...
PDF_NAME = "control_characters.pdf"
PDF_STEM = "control_characters"
PDF_REL_PATH = "control_characters.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "control_characters"
...
def test_text_extraction_control_characters(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for control_characters.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_control_characters(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for control_characters.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
