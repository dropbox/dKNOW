...
PDF_NAME = "feature_linearized_loading.pdf"
PDF_STEM = "feature_linearized_loading"
PDF_REL_PATH = "feature_linearized_loading.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "feature_linearized_loading"
...
def test_text_extraction_feature_linearized_loading(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for feature_linearized_loading.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_feature_linearized_loading(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for feature_linearized_loading.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
