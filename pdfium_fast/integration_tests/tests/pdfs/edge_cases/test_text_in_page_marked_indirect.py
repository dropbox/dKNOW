...
PDF_NAME = "text_in_page_marked_indirect.pdf"
PDF_STEM = "text_in_page_marked_indirect"
PDF_REL_PATH = "text_in_page_marked_indirect.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "text_in_page_marked_indirect"
...
def test_text_extraction_text_in_page_marked_indirect(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for text_in_page_marked_indirect.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_text_in_page_marked_indirect(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for text_in_page_marked_indirect.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
