...
PDF_NAME = "bug_1055869.pdf"
PDF_STEM = "bug_1055869"
PDF_REL_PATH = "bug_1055869.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "bug_1055869"
...
def test_text_extraction_bug_1055869(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for bug_1055869.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_bug_1055869(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for bug_1055869.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
