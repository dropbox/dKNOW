...
PDF_NAME = "text_render_mode.pdf"
PDF_STEM = "text_render_mode"
PDF_REL_PATH = "text_render_mode.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "text_render_mode"
...
def test_text_extraction_text_render_mode(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for text_render_mode.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_text_render_mode(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for text_render_mode.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
