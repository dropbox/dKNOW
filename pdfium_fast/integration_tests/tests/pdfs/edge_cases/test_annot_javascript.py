...
PDF_NAME = "annot_javascript.pdf"
PDF_STEM = "annot_javascript"
PDF_REL_PATH = "annot_javascript.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "annot_javascript"
...
def test_text_extraction_annot_javascript(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for annot_javascript.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_annot_javascript(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for annot_javascript.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
