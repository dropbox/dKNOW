...
PDF_NAME = "form_object_with_image.pdf"
PDF_STEM = "form_object_with_image"
PDF_REL_PATH = "form_object_with_image.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "form_object_with_image"
...
def test_text_extraction_form_object_with_image(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for form_object_with_image.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_form_object_with_image(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for form_object_with_image.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
