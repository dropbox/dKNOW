...
PDF_NAME = "cropped_no_overlap.pdf"
PDF_STEM = "cropped_no_overlap"
PDF_REL_PATH = "cropped_no_overlap.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "cropped_no_overlap"
...
def test_text_extraction_cropped_no_overlap(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for cropped_no_overlap.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_cropped_no_overlap(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for cropped_no_overlap.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
