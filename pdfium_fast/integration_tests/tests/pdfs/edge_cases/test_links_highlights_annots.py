...
PDF_NAME = "links_highlights_annots.pdf"
PDF_STEM = "links_highlights_annots"
PDF_REL_PATH = "links_highlights_annots.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "links_highlights_annots"
...
def test_text_extraction_links_highlights_annots(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for links_highlights_annots.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_links_highlights_annots(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for links_highlights_annots.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
