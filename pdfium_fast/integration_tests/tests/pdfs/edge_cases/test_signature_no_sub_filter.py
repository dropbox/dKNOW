...
PDF_NAME = "signature_no_sub_filter.pdf"
PDF_STEM = "signature_no_sub_filter"
PDF_REL_PATH = "signature_no_sub_filter.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "signature_no_sub_filter"
...
def test_text_extraction_signature_no_sub_filter(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for signature_no_sub_filter.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_signature_no_sub_filter(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for signature_no_sub_filter.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
