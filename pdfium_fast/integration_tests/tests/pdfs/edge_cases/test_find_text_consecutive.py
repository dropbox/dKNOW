...
PDF_NAME = "find_text_consecutive.pdf"
PDF_STEM = "find_text_consecutive"
PDF_REL_PATH = "find_text_consecutive.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "find_text_consecutive"
...
def test_text_extraction_find_text_consecutive(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for find_text_consecutive.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_find_text_consecutive(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for find_text_consecutive.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
