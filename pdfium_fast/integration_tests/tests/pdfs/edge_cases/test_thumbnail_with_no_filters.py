...
PDF_NAME = "thumbnail_with_no_filters.pdf"
PDF_STEM = "thumbnail_with_no_filters"
PDF_REL_PATH = "thumbnail_with_no_filters.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "thumbnail_with_no_filters"
...
def test_text_extraction_thumbnail_with_no_filters(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for thumbnail_with_no_filters.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_thumbnail_with_no_filters(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for thumbnail_with_no_filters.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
