...
PDF_NAME = "viewer_pref_types.pdf"
PDF_STEM = "viewer_pref_types"
PDF_REL_PATH = "viewer_pref_types.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "viewer_pref_types"
...
def test_text_extraction_viewer_pref_types(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for viewer_pref_types.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_viewer_pref_types(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for viewer_pref_types.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
