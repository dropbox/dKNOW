...
PDF_NAME = "weblinks_across_lines.pdf"
PDF_STEM = "weblinks_across_lines"
PDF_REL_PATH = "weblinks_across_lines.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "weblinks_across_lines"
...
def test_text_extraction_weblinks_across_lines(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for weblinks_across_lines.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_weblinks_across_lines(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for weblinks_across_lines.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
