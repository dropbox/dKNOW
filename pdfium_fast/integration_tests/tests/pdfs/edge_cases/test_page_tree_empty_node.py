...
PDF_NAME = "page_tree_empty_node.pdf"
PDF_STEM = "page_tree_empty_node"
PDF_REL_PATH = "page_tree_empty_node.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "page_tree_empty_node"
...
def test_text_extraction_page_tree_empty_node(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for page_tree_empty_node.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_page_tree_empty_node(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for page_tree_empty_node.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
