...
PDF_NAME = "encrypted_hello_world_r3.pdf"
PDF_STEM = "encrypted_hello_world_r3"
PDF_REL_PATH = "encrypted_hello_world_r3.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "encrypted_hello_world_r3"
...
def test_text_extraction_encrypted_hello_world_r3(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for encrypted_hello_world_r3.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_encrypted_hello_world_r3(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for encrypted_hello_world_r3.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
