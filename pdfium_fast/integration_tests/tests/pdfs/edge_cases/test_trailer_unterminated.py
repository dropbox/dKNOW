...
PDF_NAME = "trailer_unterminated.pdf"
PDF_STEM = "trailer_unterminated"
PDF_REL_PATH = "trailer_unterminated.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "trailer_unterminated"
...
def test_text_extraction_trailer_unterminated(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for trailer_unterminated.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_trailer_unterminated(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for trailer_unterminated.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
