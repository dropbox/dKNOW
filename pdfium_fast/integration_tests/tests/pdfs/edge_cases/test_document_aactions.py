...
PDF_NAME = "document_aactions.pdf"
PDF_STEM = "document_aactions"
PDF_REL_PATH = "document_aactions.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "document_aactions"
...
def test_text_extraction_document_aactions(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for document_aactions.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_document_aactions(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for document_aactions.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
