...
PDF_NAME = "parser_rebuildxref_correct.pdf"
PDF_STEM = "parser_rebuildxref_correct"
PDF_REL_PATH = "parser_rebuildxref_correct.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "parser_rebuildxref_correct"
...
def test_text_extraction_parser_rebuildxref_correct(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for parser_rebuildxref_correct.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_parser_rebuildxref_correct(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for parser_rebuildxref_correct.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
