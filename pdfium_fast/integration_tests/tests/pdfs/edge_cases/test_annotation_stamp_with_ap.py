...
PDF_NAME = "annotation_stamp_with_ap.pdf"
PDF_STEM = "annotation_stamp_with_ap"
PDF_REL_PATH = "annotation_stamp_with_ap.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "annotation_stamp_with_ap"
...
def test_text_extraction_annotation_stamp_with_ap(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for annotation_stamp_with_ap.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_annotation_stamp_with_ap(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for annotation_stamp_with_ap.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
