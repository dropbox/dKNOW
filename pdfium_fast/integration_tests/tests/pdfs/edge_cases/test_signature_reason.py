...
PDF_NAME = "signature_reason.pdf"
PDF_STEM = "signature_reason"
PDF_REL_PATH = "signature_reason.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "signature_reason"
...
def test_text_extraction_signature_reason(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for signature_reason.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_signature_reason(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for signature_reason.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
