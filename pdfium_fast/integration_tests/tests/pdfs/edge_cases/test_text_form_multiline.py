...
PDF_NAME = "text_form_multiline.pdf"
PDF_STEM = "text_form_multiline"
PDF_REL_PATH = "text_form_multiline.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "text_form_multiline"
...
def test_text_extraction_text_form_multiline(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for text_form_multiline.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_text_form_multiline(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for text_form_multiline.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
