...
PDF_NAME = "text_form_multiple.pdf"
PDF_STEM = "text_form_multiple"
PDF_REL_PATH = "text_form_multiple.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "text_form_multiple"
...
def test_text_extraction_text_form_multiple(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for text_form_multiple.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_text_form_multiple(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for text_form_multiple.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
