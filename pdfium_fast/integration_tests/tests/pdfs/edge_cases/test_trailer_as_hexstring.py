...
PDF_NAME = "trailer_as_hexstring.pdf"
PDF_STEM = "trailer_as_hexstring"
PDF_REL_PATH = "trailer_as_hexstring.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "trailer_as_hexstring"
...
def test_text_extraction_trailer_as_hexstring(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for trailer_as_hexstring.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_trailer_as_hexstring(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for trailer_as_hexstring.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
