"""
Tests for named_dests_old_style.pdf
...
PDF_NAME = "named_dests_old_style.pdf"
PDF_STEM = "named_dests_old_style"
PDF_REL_PATH = "named_dests_old_style.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "named_dests_old_style"
...
def test_text_extraction_named_dests_old_style(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for named_dests_old_style.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_named_dests_old_style(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for named_dests_old_style.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
