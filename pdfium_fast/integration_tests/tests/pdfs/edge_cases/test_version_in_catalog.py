...
PDF_NAME = "version_in_catalog.pdf"
PDF_STEM = "version_in_catalog"
PDF_REL_PATH = "version_in_catalog.pdf"
EXPECTED_DIR = Path(__file__).parent.parent.parent.parent / "master_test_suite" / "expected_outputs" / "edge_cases" / "version_in_catalog"
...
def test_text_extraction_version_in_catalog(edge_cases_pdfs, extract_text_tool_dispatcher, optimized_lib, expected_outputs):
    """Text extraction correctness for version_in_catalog.pdf"""
...
@pytest.mark.batch_bulk
@pytest.mark.edge_cases
def test_jsonl_extraction_version_in_catalog(edge_cases_pdfs, optimized_lib, expected_outputs, pdfium_root):
    """JSONL extraction for version_in_catalog.pdf (page 0 only)"""
    pdf_path = edge_cases_pdfs / PDF_REL_PATH
    manifest_path = EXPECTED_DIR / "manifest.json"
